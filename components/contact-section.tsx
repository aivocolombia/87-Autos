  ...
  return (
    <section id="contact" className="relative py-20 bg-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-wider text-gray-900 mb-6">
            HABLEMOS DE TU
            <span className="block text-blue-600">SIGUIENTE AUTO</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Estamos aquí para ayudarte a encontrar el BMW o Mini Cooper perfecto.
            Contáctanos y comienza tu viaje hacia la excelencia automotriz.
          </p>
        </motion.div>
      ...
      {/* Floating Elements */}
      <div className="absolute top-20 right-10 w-20 h-20 bg-blue-100 rounded-full opacity-20 animate-float" />
      <div className="absolute bottom-32 left-16 w-16 h-16 bg-blue-200 rounded-full opacity-30 animate-float" style={{ animationDelay: '2s' }} />
      <div className="absolute top-1/2 left-8 w-12 h-12 bg-blue-300 rounded-full opacity-25 animate-float" style={{ animationDelay: '4s' }} />
